...
- Hourly forecast with feels-like, wind (speed + direction), humidity, UV, cloud cover, visibility, dew point, rain chance + amount and a 7-day outlook (Today/Tomorrow, high, low, feels-like high/low, peak wind, peak gusts, peak UV, sunrise–sunset, sunshine duration, hours of rain, rain chance + daily precip + snowfall)
- Times shown in the place timezone (not the browser timezone)
- °C / °F toggle (wind km/h or mph; precip mm or in; snowfall cm or in; visibility km or mi; remembered)
