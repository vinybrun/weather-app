...
- Hourly forecast with feels-like, wind (speed + direction + gusts), humidity, UV, cloud cover, visibility, dew point, pressure, rain chance + amount and a 7-day outlook (Today/Tomorrow, high, low, feels-like high/low, peak wind, peak gusts, peak UV, sunrise–sunset, sunshine duration, solar radiation, evapotranspiration, hours of rain, rain chance + daily precip + snowfall)
