...
- Hourly forecast with feels-like, wind (speed + direction), humidity, rain chance + amount and a 7-day outlook (Today/Tomorrow, high, low, peak wind, peak UV, sunrise–sunset, rain chance + daily precip + snowfall)
