...
test("formats hourly mid cloud and daily mean CAPE", () => {
  assert.equal(formatMidCloud(36.6), "37% mid");
  assert.equal(formatMidCloud(0), "0% mid");
  assert.equal(formatMidCloud(null), "—");
  assert.equal(hourlyMidCloudLabel(36.6), "37% mid");
  assert.equal(hourlyMidCloudLabel(0), "0% mid");
  assert.equal(hourlyMidCloudLabel(-0.1), "");
  assert.equal(hourlyMidCloudLabel(null), "");
  assert.equal(hourlyMidCloudLabel(Number.NaN), "");
  assert.equal(dailyCapeMeanLabel(320), "mean CAPE 320 J/kg");
...
test("formats hourly 18cm soil temperature and daily mean gusts", () => {
  assert.equal(hourlySoilTemp18Label(13.6, "c"), "soil 18cm 14°C");
  assert.equal(hourlySoilTemp18Label(20, "f"), "soil 18cm 68°F");
  assert.equal(hourlySoilTemp18Label(null), "");
  assert.equal(hourlySoilTemp18Label(Number.NaN), "");
  assert.equal(dailyGustMeanLabel(20, "c"), "mean gusts 20 km/h");
  assert.equal(dailyGustMeanLabel(32, "f"), "mean gusts 20 mph");
...
test("formats hourly surface pressure and daily mean sea-level pressure", () => {
  assert.equal(hourlySurfacePressureLabel(1009.4, "c"), "sfc 1009 hPa");
  assert.equal(hourlySurfacePressureLabel(1013.25, "f"), "sfc 29.92 inHg");
  assert.equal(hourlySurfacePressureLabel(null), "");
  assert.equal(hourlySurfacePressureLabel(Number.NaN), "");
  assert.equal(dailyPressureMeanLabel(1013.2, "c"), "mean 1013 hPa");
